...
with open(os.getenv("DATA_PATH"),"r", encoding="utf-8") as creds:
    ...
    valid_user_credentials: dict[str, str] = data["credentials"]["valid_users"][0]
    add_item_to_cart: dict = data["payloads"]["request_payloads"][0]
...
def test_add_item_api():
    ...
    payload_add_item = add_item_to_cart
